const levels = [
  ...
  },
  {
  ...
  
   {
    images: [
       ...
       require('../assets/Images/snack/snack2.jpg'),
       require('../assets/Images/snack/snack3.jpg'),
       require('../assets/Images/snack/snack4.jpg'),
     ],
    word: "SNACK",
    category: "Food",
    definition: "Snack refers to a small portion of food eaten between meals. Snacks are typically consumed to satisfy hunger or cravings, provide energy, or simply as a quick and convenient bite."
  },
   ...
   {
    images: [
       require('../assets/Images/dessert/dessert1.jpg'),
       require('../assets/Images/dessert/dessert2.jpg'),
       require('../assets/Images/dessert/dessert3.jpg'),
       require('../assets/Images/dessert/dessert4.jpg'),
     ],
    word: "DESSERT",
    category: "Food",
  ...
  {
    images: [
       require('../assets/Images/pale/pale1.jpg'),
       require('../assets/Images/pale/pale2.jpg'),
  ...
  {
    images: [
       require('../assets/Images/curls/curls1.jpg'),
       require('../assets/Images/curls/curls2.jpg'),
       require('../assets/Images/curls/curls3.jpg'),
       require('../assets/Images/curls/curls4.jpg'),
     ],
    word: "CURLS",
    category: "Race",
    definition: "Curls typically refers to a type of hair texture or a particular style. It describes hair that is naturally or intentionally formed into spiral or ringlet shapes. Curls can vary in size, from tight coils to loose waves, and can be found in various hair types, including straight, wavy, and curly. People often use styling tools such as curling irons or rollers to create or enhance curls in their hair. Curls can add volume, texture, and dimension to hairstyles, and they are a popular choice for achieving a playful or romantic look."
  },
  ...
  },
  {
    images: [
       ...
       require('../assets/Images/racist/racism2.jpg'),
       require('../assets/Images/racist/racism3.jpg'),
       require('../assets/Images/racist/racism4.jpg'),
     ],
    word: "RACISM",
    category: "Race",
  ...
  {
    images: [
       require('../assets/Images/unicorn/unicorn1.jpg'),
       require('../assets/Images/unicorn/unicorn2.jpg'),
       require('../assets/Images/unicorn/unicorn3.jpg'),
       require('../assets/Images/unicorn/unicorn4.jpg'),
     ],
    word: "UNICORN",
    category: "Creatures",
    definition: "A unicorn is a mythical creature often depicted as a horse-like animal with a single, spiraling horn projecting from its forehead. In folklore and mythology, unicorns are often associated with purity, grace, and magic, and they have been depicted in various cultures throughout history.The image of the unicorn has been popularized in literature, art, and popular culture, often symbolizing qualities such as innocence, beauty, and rarity. In many stories, unicorns are depicted as elusive and mystical creatures that are difficult to capture or tame. In modern popular culture, unicorns have become a popular symbol associated with fantasy, whimsy, and imagination. They are often featured in children's books, animated films, and fantasy novels, as well as on various consumer products such as toys, clothing, and accessories."
  },
...

  {
    images: [
       ...
       require('../assets/Images/troll/troll4.jpg'),
     ],
    word: "TROLL",
    category: "Creatures",
 ...
 
  {
    images: [
       ...
       require('../assets/Images/chimera/chimera2.jpg'),
       require('../assets/Images/chimera/chimera3.jpg'),
       require('../assets/Images/chimera/chimera4.jpg'),
     ],
    word: "CHIMERA",
    category: "Creatures",
    definition: "A chimera is a mythical creature from ancient Greek mythology, typically depicted as a hybrid creature composed of parts from various animals. The most common representation of a chimera includes the body of a lion, the head of a goat protruding from its back, and a tail ending in a snake's head. In mythology, the chimera was said to be a monstrous and fearsome creature, capable of breathing fire and causing destruction wherever it went. It was often associated with chaos, danger, and the unknown. The chimera appears in various ancient Greek stories and legends, including the tale of Bellerophon and the Chimera. According to this myth, Bellerophon, a hero, was tasked with slaying the chimera as one of his heroic feats. With the help of the winged horse Pegasus, Bellerophon was able to defeat the chimera by using a combination of cunning and skill."
  },
  ...
  {
    images: [
       require('../assets/Images/beige/beige1.jpg'),
       require('../assets/Images/beige/beige2.jpg'),
       require('../assets/Images/beige/beige3.jpg'),
       require('../assets/Images/beige/beige4.jpg'),
     ],
    word: "BEIGE",
    category: "Color",
  ...
  {
    images: [
       require('../assets/Images/cyan/cyan1.jpg'),
       require('../assets/Images/cyan/cyan2.jpg'),
       require('../assets/Images/cyan/cyan3.jpg'),
       require('../assets/Images/cyan/cyan4.jpg'),
     ],
    word: "CYAN",
    category: "Color",
 ...
 },
 {
  ...
  {
    images: [
       require('../assets/Images/annelid/annelid1.jpg'),
       require('../assets/Images/annelid/annelid2.jpg'),
       require('../assets/Images/annelid/annelid3.jpg'),
       require('../assets/Images/annelid/annelid4.jpg'),
     ],
    word: "ANNELID",
    category: "Animals",
    definition:"Annelids are a diverse phylum of invertebrates that include segmented worms. They are characterized by their cylindrical bodies segmented into repeating units called metameres or somites. Annelids inhabit a variety of environments, including marine, freshwater, and terrestrial habitats."
  },

  {
    images: [
       require('../assets/Images/arachnid/arachnid1.jpg'),
       require('../assets/Images/arachnid/arachnid2.jpg'),
       require('../assets/Images/arachnid/arachnid3.jpg'),
       require('../assets/Images/arachnid/arachnid4.jpg'),
     ],
    word: "ARACHNID",
    category: "Animals",
  ...
  {
    images: [
       require('../assets/Images/desert/desert1.jpg'),
       require('../assets/Images/desert/desert2.jpg'),
 ...
 {
  images: [
     require('../assets/Images/tundra/tundra1.jpg'),
     require('../assets/Images/tundra/tundra2.jpg'),
     require('../assets/Images/tundra/tundra3.jpg'),
     require('../assets/Images/tundra/tundra4.jpg'),
   ],
  word: "TUNDRA",
  category: "Geography",
  definition:"The tundra is a vast biome characterized by its cold, treeless landscape found in regions with long, harsh winters, such as the Arctic and subarctic regions of North America, Europe, and Asia. The tundra experiences extremely low temperatures, with permafrost (permanently frozen ground) covering much of the land."
},

 {
  ...
  {
    images: [
       require('../assets/Images/tractor/tractor1.jpg'),
       require('../assets/Images/tractor/tractor2.jpg'),
       require('../assets/Images/tractor/tractor3.jpg'),
       require('../assets/Images/tractor/tractor4.jpg'),
     ],
    word: "TRACTOR",
    category: "Vehicle",
...

  {
    images: [
       ...
       require('../assets/Images/yacht/yacht4.jpg'),
     ],
    word: "YACHT",
    category: "Vehicle",
    definition: "A yacht is a luxurious and typically large recreational boat that is used for pleasure cruising, racing, or as a status symbol. Yachts can range from small vessels used for day trips to massive superyachts equipped with amenities like swimming pools, jacuzzis, helipads, and multiple decks for entertaining guests. They are often associated with wealth and extravagance, and owning or chartering a yacht can be a symbol of affluence and luxury lifestyle. "
  },
...

{
  ...
  {
    images: [
       require('../assets/Images/dab/dab1.jpg'),
       require('../assets/Images/dab/dab2.jpg'),
       require('../assets/Images/dab/dab3.jpg'),
       require('../assets/Images/dab/dab4.jpg'),
     ],
    word: "DAB",
    category: "Dance",
    definition:"The dab is a popular dance move that gained widespread attention and popularity in the 2010s, particularly in hip-hop and pop culture. It involves a simple yet distinctive gesture where one dips their head into the crook of one bent elbow while extending the other arm straight out to the side or upwards. The overall pose resembles someone sneezing or coughing into their elbow. The origins of the dab are somewhat debated, but it is believed to have emerged from the Atlanta hip-hop scene, with some attributing its creation to hip-hop artist Skippa Da Flippa or members of the Migos rap group. The dab gained mainstream recognition through its use by athletes, musicians, and celebrities, as well as its inclusion in viral videos and memes."
  },
  ...
  
 {
  ...
  {
    images: [
       require('../assets/Images/sacred/sacred1.jpg'),
       require('../assets/Images/sacred/sacred2.jpg'),
       require('../assets/Images/sacred/sacred3.jpg'),
       require('../assets/Images/sacred/sacred4.jpg'),
     ],
    word: "SACRED",
    category: "Religion",
    definition:"Sacred refers to something that is regarded with reverence, respect, and significance, often associated with religious or spiritual beliefs. It denotes a quality of being holy, divine, or set apart from the mundane world.In religious contexts, objects, places, rituals, texts, and even individuals can be considered sacred. These hold special meaning and are often treated with utmost reverence and care. Sacredness can extend to natural phenomena, such as mountains, rivers, or trees, which are believed to possess spiritual significance in certain cultures or belief systems.The concept of the sacred is deeply ingrained in various religious traditions and spiritual practices worldwide. It serves to establish a connection between individuals and the divine, providing a framework for understanding the mysteries of existence and the transcendent aspects of life."
  },
  ...
  {
    images: [
       require('../assets/Images/deity/deity1.jpg'),
       require('../assets/Images/deity/deity2.jpg'),
       require('../assets/Images/deity/deity3.jpg'),
       require('../assets/Images/deity/deity4.jpg'),
     ],
    word: "DEITY",
    category: "Religion",
  ...
  {
    images: [
       require('../assets/Images/manager/manager1.jpg'),
       require('../assets/Images/manager/manager2.jpg'),
       require('../assets/Images/manager/manager3.jpg'),
       require('../assets/Images/manager/manager4.jpg'),
     ],
    word: "MANAGER",
    category: "Career",
    definition: "A manager is an individual within an organization who is responsible for overseeing and directing the activities of a team, department, or division to achieve specific goals and objectives. Managers play a crucial role in coordinating resources, making decisions, and ensuring the efficient functioning of their area of responsibility."
  },
  ...
  {
    images: [
       require('../assets/Images/wage/wage1.jpg'),
       require('../assets/Images/wage/wage2.jpg'),
       require('../assets/Images/wage/wage3.jpg'),
       require('../assets/Images/wage/wage4.jpg'),
     ],
    word: "WAGE",
    category: "Career",
  ...
  {
    images: [
       require('../assets/Images/mutant/mutant1.jpg'),
       require('../assets/Images/mutant/mutant2.jpg'),
       require('../assets/Images/mutant/mutant3.jpg'),
       require('../assets/Images/mutant/mutant4.jpg'),
     ],
    word: "MUTANT",
    category: "Comics",
  ...
  {
    images: [
       require('../assets/Images/fabric/fabric1.jpg'),
       require('../assets/Images/fabric/fabric2.jpg'),
       require('../assets/Images/fabric/fabric3.jpg'),
       require('../assets/Images/fabric/fabric4.jpg'),
     ],
    word: "FABRIC",
    category: "Fashion",
    definition: "Fabric refers to any material made by weaving, knitting, felting, or otherwise bonding fibers together. It is commonly used in the production of clothing, upholstery, bedding, curtains, and various other items. Fabrics can be made from natural fibers, such as cotton, wool, silk, and linen, or from synthetic fibers, such as polyester, nylon, and acrylic. Different types of fabrics have distinct characteristics in terms of texture, weight, durability, and appearance. For example, cotton is known for its softness and breathability, while wool is prized for its warmth and resilience. Silk is renowned for its luxurious feel and lustrous appearance, while polyester is valued for its durability and wrinkle resistance."
  },
  ...
  {
    images: [
       require('../assets/Images/runway/runway1.jpg'),
       require('../assets/Images/runway/runway2.jpg'),
       require('../assets/Images/runway/runway3.jpg'),
       require('../assets/Images/runway/runway4.jpg'),
     ],
    word: "RUNWAY",
    category: "Fashion",
    definition: "A runway is a long, narrow strip of paved or unpaved ground, typically used for the takeoff and landing of aircraft. It serves as a designated area for airplanes to maneuver during departure and arrival at airports. Runways are essential infrastructure components of airports, allowing aircraft to safely and efficiently take off and land. In addition to airports, runways are also used in other contexts, such as military bases and spaceports, where aircraft or spacecraft require a designated area for takeoff and landing. Runways are constructed with specific dimensions, materials, and markings to meet safety standards and accommodate different types of aircraft."
  },

  {
    images: [
       require('../assets/Images/boutique/boutique1.jpg'),
       require('../assets/Images/boutique/boutique2.jpg'),
       require('../assets/Images/boutique/boutique3.jpg'),
       require('../assets/Images/boutique/boutique4.jpg'),
     ],
    word: "BOUTIQUE",
    category: "Fashion",
    definition: "A boutique is a small retail store that specializes in selling unique, stylish, and often upscale merchandise. Unlike larger department stores, boutiques typically offer a curated selection of products in a specific niche or style, catering to a particular clientele with discerning tastes. Boutiques often focus on clothing, accessories, jewelry, or home decor items, and they may feature items from independent designers, local artisans, or exclusive brands. The atmosphere of a boutique is often intimate and personalized, with attentive customer service and a carefully curated shopping experience."
  },
  ...
  {
    images: [
       require('../assets/Images/sleep/sleep1.jpg'),
       require('../assets/Images/sleep/sleep2.jpg'),
       require('../assets/Images/sleep/sleep3.jpg'),
       require('../assets/Images/sleep/sleep4.jpg'),
     ],
    word: "SLEEP",
    category: "Lifestyle",
  ...
  
  {
    ...
    word: "HYGIENE",
    category: "Lifestle",
    definition: "Hygiene is a set of practices performed to preserve health. According to the World Health Organization (WHO), Hygiene refers to conditions and practices that help to maintain health and prevent the spread of diseases.Personal hygiene refers to maintaining the body's cleanliness. Hygiene activities can be grouped into the following: home and everyday hygiene, personal hygiene, medical hygiene, sleep hygiene, and food hygiene. Home and every day hygiene includes hand washing, respiratory hygiene, food hygiene at home, hygiene in the kitchen, hygiene in the bathroom, laundry hygiene, and medical hygiene at home. Many people equate hygiene with cleanliness, but hygiene is a broad term. It includes such personal habit choices as how frequently to take a shower or bath, wash hands, trim fingernails, and wash clothes. "
  },
...

  {
    images: [
       ...
       require('../assets/Images/interior/interior4.jpg'),
     ],
    word: "INTERIOR",
    category: "Architecture",
  ...
  {
    images: [
       require('../assets/Images/orbit/orbit1.jpg'),
       require('../assets/Images/orbit/orbit2.jpg'),
       require('../assets/Images/orbit/orbit3.jpg'),
       require('../assets/Images/orbit/orbit4.jpg'),
     ],
    word: "ORBIT",
    category: "Astronomy",
  ...
  {
    images: [
       require('../assets/Images/pulsar/pulsar1.jpg'),
       require('../assets/Images/pulsar/pulsar2.jpg'),
       require('../assets/Images/pulsar/pulsar3.jpg'),
       require('../assets/Images/pulsar/pulsar4.jpg'),
     ],
    word: "PULSAR",
    category: "Astronomy",
    definition: "A pulsar is a highly magnetized, rotating neutron star or white dwarf that emits beams of electromagnetic radiation out of its magnetic poles. These beams of radiation can only be observed when they are pointing towards Earth, much like a lighthouse beacon. Pulsars are incredibly dense objects, typically about the size of a city but containing more mass than the Sun. They are formed from the remnants of massive stars that have undergone supernova explosions."
  },
  ...
  {
    images: [
       require('../assets/Images/garden/garden1.jpg'),
       require('../assets/Images/garden/garden2.jpg'),
       require('../assets/Images/garden/garden3.jpg'),
       require('../assets/Images/garden/garden4.jpg'),
     ],
    word: "GARDEN",
    category: "Plant",
    definition: "A garden is an area of land, typically cultivated or landscaped, where plants, flowers, vegetables, fruits, or herbs are grown for aesthetic, recreational, or practical purposes. Gardens can vary widely in size, style, and purpose, ranging from small urban plots to expansive botanical gardens or ornamental landscapes."
  },
  ...
  {
    images: [
       require('../assets/Images/drone/drone1.jpg'),
       require('../assets/Images/drone/drone2.jpg'),
       require('../assets/Images/drone/drone3.jpg'),
       require('../assets/Images/drone/drone4.jpg'),
     ],
    word: "DRONE",
    category: "Technology",
    definition: "Drones, also known as unmanned aerial vehicles (UAVs), are aircraft operated without a human pilot onboard. They can be controlled remotely by a human operator or autonomously by onboard computers. Drones come in various shapes and sizes, from small quadcopters used for recreational purposes to large fixed-wing aircraft employed for military surveillance or commercial applications like mapping, agriculture, and aerial photography."
  },
  ...
  {
    images: [
       require('../assets/Images/hacker/hacker1.jpg'),
       require('../assets/Images/hacker/hacker2.jpg'),
       require('../assets/Images/hacker/hacker3.jpg'),
       require('../assets/Images/hacker/hacker4.jpg'),
     ],
    word: "HACKER",
    category: "Technology",
    definition: "A hacker is an individual who uses their technical skills and knowledge of computer systems and networks to gain unauthorized access to digital information, manipulate computer systems, or disrupt online activities. Hacking can have serious legal and ethical implications, and unauthorized access to computer systems and networks is considered a criminal offense in many jurisdictions. However, ethical hacking can play a vital role in improving cybersecurity and protecting against cyber threats."
  },
  ...
  {
    images: [
       require('../assets/Images/lonely/lonely1.jpg'),
       require('../assets/Images/lonely/lonely2.jpg'),
       require('../assets/Images/lonely/lonely3.jpg'),
       require('../assets/Images/lonely/lonely4.jpg'),
     ],
    word: "LONELY",
    category: "Emotions",
  ...
  {
    images: [
       require('../assets/Images/surprise/surprise1.jpg'),
       require('../assets/Images/surprise/surprise2.jpg'),
       require('../assets/Images/surprise/surprise3.jpg'),
       require('../assets/Images/surprise/surprise4.jpg'),
     ],
    word: "SURPRISE",
    category: "Emotions",
    definition: "Surprise refers to an unexpected event, action, or revelation that catches someone off guard or causes them to feel astonishment, wonder, or excitement. It is a spontaneous and often joyful emotion experienced when something unexpected happens."
  },

  {
    images: [
       require('../assets/Images/grief/grief1.jpg'),
       require('../assets/Images/grief/grief2.jpg'),
       require('../assets/Images/grief/grief3.jpg'),
       require('../assets/Images/grief/grief4.jpg'),
     ],
    word: "GRIEF",
    category: "Emotions",
    definition: "Grief is a complex and natural response to loss, particularly the loss of someone or something significant in our lives. It's not just about losing a loved one through death; it can also be triggered by other losses such as the end of a relationship, loss of a job, or even the loss of a cherished dream. Grieving is a highly individual experience, and people may react to loss in different ways. Some common emotions experienced during grief include sadness, anger, guilt, confusion, and numbness. These emotions can be intense and may come in waves, often fluctuating over time."
  },
  ...
  {
    images: [
       require('../assets/Images/whisk/whisk1.jpg'),
       require('../assets/Images/whisk/whisk2.jpg'),
       require('../assets/Images/whisk/whisk3.jpg'),
       require('../assets/Images/whisk/whisk4.jpg'),
     ],
    word: "WHISK",
    category: "Instruments",
    definition: "A whisk is a kitchen utensil used for mixing, beating, and whipping ingredients together. It typically consists of thin, looped wires or metal tines attached to a handle. Whisks come in various sizes and shapes, with some designed for specific tasks like whisking eggs, blending sauces, or incorporating air into batters. The design of a whisk allows for efficient mixing by incorporating air into the ingredients, resulting in smoother textures and better incorporation of liquids and dry ingredients. Whisks are commonly used in baking to blend ingredients like eggs, flour, and liquids to create batter or dough. They are also useful for mixing sauces, gravies, dressings, and other culinary preparations."
  },
  ...
  
  {
    images: [
       ...
       require('../assets/Images/scalpel/scalpel2.jpg'),
       require('../assets/Images/scalpel/scalpel3.jpg'),
       require('../assets/Images/scalpel/scalpel4.jpg'),
     ],
    word: "SCALPEL",
    category: "Instruments",
    definition: "A scalpel is a small, sharp knife used in surgery, dissection, and other medical procedures for making precise incisions. It typically has a thin, pointed blade with a handle, allowing surgeons and medical professionals to perform delicate and controlled cutting tasks with accuracy. Scalpels are available in various sizes and shapes, each suited for specific purposes. They are commonly used in surgical settings to make clean, precise cuts during procedures ranging from simple skin incisions to complex surgeries. The sharpness and precision of a scalpel blade are essential for minimizing tissue damage and achieving optimal surgical outcomes."
  },
...

  {
    ...
    {
    images: [
       require('../assets/Images/visa/visa1.jpg'),
       require('../assets/Images/visa/visa2.jpg'),
       require('../assets/Images/visa/visa3.jpg'),
       require('../assets/Images/visa/visa4.jpg'),
     ],
    word: "VISA",
    category: "Tourism",
    definition: "A visa is an official document or endorsement stamped or affixed in a passport, granting permission for an individual to enter, leave, or stay in a foreign country for a specified period and for a particular purpose. Visas are typically issued by the immigration authorities of the country the individual wishes to visit or reside in. The requirements for obtaining a visa vary depending on the country's immigration laws, the purpose of the visit (such as tourism, work, study, or family reunion), and the nationality of the applicant. Common types of visas include tourist visas, work visas, student visas, and family visas."
  },

    {
    images: [
       require('../assets/Images/guide/guide1.jpg'),
       require('../assets/Images/guide/guide2.jpg'),
       require('../assets/Images/guide/guide3.jpg'),
       require('../assets/Images/guide/guide4.jpg'),
     ],
    word: "GUIDE",
    category: "Tourism",
    definition: "A tourist guide is a person who provides information and assistance to travelers visiting a particular destination. Tourist guides are knowledgeable about the history, culture, attractions, and points of interest of the area they cover, and they offer guided tours to help visitors explore and learn more about the destination."
  },

  {
    images: [
       require('../assets/Images/festival/festival1.jpg'),
       require('../assets/Images/festival/festival2.jpg'),
       require('../assets/Images/festival/festival3.jpg'),
       require('../assets/Images/festival/festival4.jpg'),
     ],
    word: "FESTIVAL",
    category: "Tourism",
    definition: "A festival is a celebration or gathering that typically involves a series of events, activities, performances, and rituals, often centered around a specific theme, cultural tradition, religious observance, or seasonal occurrence. Festivals can vary widely in scale, duration, and purpose, ranging from small community gatherings to large-scale international events."
  },
  ...
  {
    images: [
       require('../assets/Images/cubism/cubism1.jpg'),
       require('../assets/Images/cubism/cubism2.jpg'),
       require('../assets/Images/cubism/cubism3.jpg'),
       require('../assets/Images/cubism/cubism4.jpg'),
     ],
    word: "CUBISM",
    category: "Art",
    definition: "Cubism is an influential art movement that emerged in the early 20th century, primarily associated with painters Pablo Picasso and Georges Braque. It revolutionized the way artists represented reality by breaking objects and subjects down into geometric shapes and presenting them from multiple viewpoints simultaneously"
  },

    {
    images: [
       require('../assets/Images/realism/realism1.jpg'),
       require('../assets/Images/realism/realism2.jpg'),
       require('../assets/Images/realism/realism3.jpg'),
       require('../assets/Images/realism/realism4.jpg'),
     ],
    word: "REALISM",
    category: "Art",
  ...
  },
  {
    images: [
       ...
       require('../assets/Images/pebble/pebble3.jpg'),
       require('../assets/Images/pebble/pebble4.jpg'),
     ],
    word: "PEBBLE",
    category: "Geology",
...

  {
    ...
    word: "RIFT",
    category: "Geology",
    definition: "A rift is a linear zone where the lithosphere is being pulled apart and is an example of extensional tectonics. Typical rift features are a central linear downfaulted depression, called a graben, or more commonly a half-graben with normal faulting and rift-flank uplifts mainly on one side. Where rifts remain above sea level they form a rift valley, which may be filled by water forming a rift lake. The axis of the rift area may contain volcanic rocks, and active volcanism is a part of many, but not all, active rift systems.Major rifts occur along the central axis of most mid-ocean ridges, where new oceanic crust and lithosphere is created along a divergent boundary between two tectonic plates. Failed rifts are the result of continental rifting that failed to continue to the point of break-up. "
  },
  {
    images: [
  ...
  {
    images: [
       require('../assets/Images/shale/shale1.jpg'),
       require('../assets/Images/shale/shale2.jpg'),
       require('../assets/Images/shale/shale3.jpg'),
       require('../assets/Images/shale/shale4.jpg'),
     ],
    word: "SHALE",
    category: "Geology",
